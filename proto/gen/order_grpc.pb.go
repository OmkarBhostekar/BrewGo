...
const (
	OrderService_PlaceOrder_FullMethodName     = "/brew.go.proto.order.OrderService/PlaceOrder"
	OrderService_FulfillOrder_FullMethodName   = "/brew.go.proto.order.OrderService/FulfillOrder"
	OrderService_GetOrderStatus_FullMethodName = "/brew.go.proto.order.OrderService/GetOrderStatus"
)
...
type OrderServiceClient interface {
	...
	FulfillOrder(ctx context.Context, in *FulfillOrderRequest, opts ...grpc.CallOption) (*OrderResponse, error)
...
func (c *orderServiceClient) FulfillOrder(ctx context.Context, in *FulfillOrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderServiceClient) GetOrderStatus(ctx context.Context, in *GetOrderStatusRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderResponse)
...
type OrderServiceServer interface {
	...
	FulfillOrder(context.Context, *FulfillOrderRequest) (*OrderResponse, error)
...
func (UnimplementedOrderServiceServer) FulfillOrder(context.Context, *FulfillOrderRequest) (*OrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FulfillOrder not implemented")
}
func (UnimplementedOrderServiceServer) GetOrderStatus(context.Context, *GetOrderStatusRequest) (*OrderResponse, error) {
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "brew.go.proto.order.OrderService",
