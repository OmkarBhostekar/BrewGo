...
const (
	ProductService_AddProduct_FullMethodName               = "/brew.go.proto.product.ProductService/AddProduct"
	ProductService_UpdateProduct_FullMethodName            = "/brew.go.proto.product.ProductService/UpdateProduct"
	ProductService_DeleteProduct_FullMethodName            = "/brew.go.proto.product.ProductService/DeleteProduct"
	ProductService_GetProduct_FullMethodName               = "/brew.go.proto.product.ProductService/GetProduct"
	ProductService_SearchProductsByName_FullMethodName     = "/brew.go.proto.product.ProductService/SearchProductsByName"
	ProductService_SearchProductsByCategory_FullMethodName = "/brew.go.proto.product.ProductService/SearchProductsByCategory"
)
...
func (c *productServiceClient) SearchProductsByName(ctx context.Context, in *SearchProductsByNameRequest, opts ...grpc.CallOption) (*SearchProductsByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) SearchProductsByCategory(ctx context.Context, in *SearchProductsByCategoryRequest, opts ...grpc.CallOption) (*SearchProductsByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchProductsByNameResponse)
	err := c.cc.Invoke(ctx, ProductService_SearchProductsByCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) SearchProductsByName(context.Context, *SearchProductsByNameRequest) (*SearchProductsByNameResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchProductsByName not implemented")
}
func (UnimplementedProductServiceServer) SearchProductsByCategory(context.Context, *SearchProductsByCategoryRequest) (*SearchProductsByNameResponse, error) {
...
func _ProductService_SearchProductsByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).SearchProductsByName(ctx, req.(*SearchProductsByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProductService_SearchProductsByCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchProductsByCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).SearchProductsByCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_SearchProductsByCategory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).SearchProductsByCategory(ctx, req.(*SearchProductsByCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "brew.go.proto.product.ProductService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_SearchProductsByCategory_Handler,
		},
	},
