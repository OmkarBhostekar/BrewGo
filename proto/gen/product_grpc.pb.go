...
const (
	...
	ProductService_ListProductsByCategory_FullMethodName = "/brew.go.proto.product.ProductService/ListProductsByCategory"
)
...
func (c *productServiceClient) ListProductsByCategory(ctx context.Context, in *ListProductsByCategoryRequest, opts ...grpc.CallOption) (*SearchProductsByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchProductsByNameResponse)
...
func (UnimplementedProductServiceServer) ListProductsByCategory(context.Context, *ListProductsByCategoryRequest) (*SearchProductsByNameResponse, error) {
