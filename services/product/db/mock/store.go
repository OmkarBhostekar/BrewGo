...
import (
	...
	product "github.com/omkarbhostekar/brewgo/services/product/db/sqlc"
)
...
func (m *MockStore) AddProduct(arg0 context.Context, arg1 product.AddProductParams) (product.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteProduct(arg0 context.Context, arg1 int32) (product.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetProductById(arg0 context.Context, arg1 int32) (product.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) SearchProductsByCategory(arg0 context.Context, arg1 product.SearchProductsByCategoryParams) ([]product.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) SearchProductsByName(arg0 context.Context, arg1 product.SearchProductsByNameParams) ([]product.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateProduct(arg0 context.Context, arg1 product.UpdateProductParams) (product.Product, error) {
	m.ctrl.T.Helper()
